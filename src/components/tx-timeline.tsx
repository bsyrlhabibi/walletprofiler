        ...
        {displayTxs.map((tx, i) => {
          ...
          return (
            <a
              ...
              className="flex items-center justify-between py-2.5 px-3 rounded-xl bg-white dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 hover:border-gray-200 dark:hover:border-gray-700 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition group shadow-sm"
            >
